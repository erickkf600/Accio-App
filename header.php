    ...
    <li>
      <div class="user-view" id="user">
        ...
        <?php }else{ 
          ...
          $consulta = mysqli_query($con, $user);
          while($s = mysqli_fetch_assoc($consulta)){
            ?>
            <div class="background">
              <img src="img/fundo2.jpg" width="100%">
            </div>
            <a href="user.php"><img class="circle" src="img/user.png"></a>
            <div class="name">
              <a><?php echo $s['usuario']; ?></a>
              <span><?php echo $s['email']; ?></span> 
            </div>
          <?php }} ?>
        </div>
      </li>
